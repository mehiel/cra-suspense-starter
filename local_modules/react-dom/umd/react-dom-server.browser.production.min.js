...
switch(a){case I:return"ConcurrentMode";case D:return"Fragment";case J:return"Portal";case K:return"Profiler";case L:return"StrictMode";case Z:return"Placeholder"}if("object"===typeof a){switch(a.$$typeof){case M:return"Context.Consumer";case E:return"Context.Provider";case N:var b=a.render;b=b.displayName||b.name||"";return a.displayName||(""!==b?"ForwardRef("+b+")":"ForwardRef")}if("function"===typeof a.then&&(a=1===a._reactStatus?a._reactResult:null))return B(a)}return null}function O(a){if(P.call(Q,
